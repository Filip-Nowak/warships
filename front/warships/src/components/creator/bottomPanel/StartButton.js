...
function StartButton({remainingShips}){
    ...
    return <div className={styles.startButton} onClick={remainingShips===0?()=>createdShipsContext.handleSubmitShips(createdShipsContext.ships):null} style={remainingShips===0?{backgroundColor:"#1BC000",color:"#001801FF"}:{backgroundColor:"#001801FF",color:"#1BC000FF"}}>
