...
function JoinRoom({joinRoom,createRoom,fetching}){
    return<Menu containerStyle={{width:"40rem",height:"30rem",marginTop:"5rem",paddingTop:"5rem"}} fetching={fetching}>
        <SubmitMessageInput  message={"enter room code"} buttonMessage={"go"} handleButtonClick={joinRoom} ></SubmitMessageInput>
        <div>
